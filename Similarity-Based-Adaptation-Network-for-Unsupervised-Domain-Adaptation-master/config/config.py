...
__C.TRAIN.TARGET_CLASS_BATCH_SIZE = 3 #如何知道目标域的类别数的呢
...
# SBDD options
__C.SBDD = edict()
__C.SBDD.KERNEL_NUM = (5, 5)
__C.SBDD.KERNEL_MUL = (2, 2)
__C.SBDD.LOSS_WEIGHT = 0.3
__C.SBDD.ALIGNMENT_FEAT_KEYS = ['feat', 'probs']
__C.SBDD.INTRA_ONLY = False
__C.SBDD.SOURCE_LOSS_WEIGHT = 0.6
__C.SBDD.TARGET_LOSS_WEIGHT = 0.6
